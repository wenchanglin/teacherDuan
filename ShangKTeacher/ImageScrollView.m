...
//  JinCaiShen
//
//  Created by Fbw on 16/4/24.
//  Copyright © 2015年 FangBoWen. All rights reserved.
//
...
- (void)addTimer{
    if (self.pics.count != 1) {
        self.time = [NSTimer scheduledTimerWithTimeInterval:2.0 target:self selector:@selector(nextImage) userInfo:nil repeats:YES];
    }
}
#pragma mark 下载图片
