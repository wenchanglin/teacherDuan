...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [_deleteBtn setBackgroundImage:[UIImage imageNamed:@"图层-65@2x.png"] forState:UIControlStateNormal];
        _deleteBtn.clipsToBounds = NO;
        _deleteBtn.frame = CGRectMake(self.tz_width - 26, 0, 16, 16);
        _deleteBtn.imageEdgeInsets = UIEdgeInsetsMake(-15, 0, 0, -15);
